                        ...
                        <JanelaCadastro func={cadastrarFuncionario}
                            ...
                            form={
                                <>
                                    ...
                                    <div>
                                        <h2>CPF</h2>
                                        <TextField error={errorIdentificacao} helperText={helperTextIdentificacao} key="cpf" required={true} onChange={(e) => {setAtribute(e.target.value, "cpf"); formatCpf(e, setErrorIdentificacao, setHelperTextIdentificacao); }}
                                            sx={{ width: '35vw', marginBottom: '3rem' }} id="outlined-basic" variant="outlined" />
                                        <h2>Senha</h2>
                        ...
                        {data.map(item => (
                            <BarraVisualizacao key={item.idFuncionario}
                                ...
                                form={<>
                                    ...
                                    <div>
                                        <h2>CPF</h2>
                                        <TextField error={errorIdentificacao} helperText={helperTextIdentificacao} key="cpf" required={true} defaultValue={aplicarMascaraCpf(item.cpf)} onChange={(e) => {updateDados(item, e.target.value, "cpf"); formatCpf(e, setErrorIdentificacao, setHelperTextIdentificacao)}}
                                            sx={{ width: '35vw', marginBottom: '3rem' }} id="outlined-basic" variant="outlined" />
                                        <h2>Permissões</h2>
                                        <SelectOptions lista={permissoes}
                                            chave={"descricao"}
